...
functional claim forces an assumption the theory never specifies, and that assumption,
not the theory, decides the result. Every disagreement above is a measurable prediction.
\end{abstract}
