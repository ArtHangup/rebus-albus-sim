...
\newcommand{\body}[1]{{\fontsize{27}{35}\selectfont\color{slate}#1}}
\newcommand{\pcap}[1]{{\fontsize{26}{34}\selectfont\color{slate}#1}}
...
{\fontsize{24}{30}\selectfont\bfseries\color{accent}The numbers: SEBUS appears
...
{\fontsize{24}{30}\selectfont\bfseries\color{accent}The numbers: the confirmed
...
{\fontsize{24}{30}\selectfont\bfseries\color{accent}The numbers: lasting crossovers
...
\begin{center}\includegraphics[width=24.4in]{figure_ratchet.png}\end{center}
