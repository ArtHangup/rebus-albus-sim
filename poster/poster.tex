...
% DOI QR added 2026-09-06 (Zenodo 10.5281/zenodo.22547758). Print-ready.
...
\newcommand{\panelhead}[1]{{\fontsize{43}{49}\selectfont\bfseries\color{slate}#1}\\[0.14in]
{\color{accent}\rule{2.6in}{3pt}}\\[0.2in]}
\newcommand{\body}[1]{{\fontsize{29}{38}\selectfont\color{slate}#1}}
\newcommand{\pcap}[1]{{\fontsize{29}{38}\selectfont\color{slate}#1}}
...
\begin{textblock*}{6.4in}(40.9in,0.5in)
\begin{minipage}[t]{3.1in}
\begin{center}
\includegraphics[width=2.15in]{qr_doi.png}\\[0.05in]
{\fontsize{15}{19}\selectfont\color{slate}\bfseries the paper (DOI)\\
doi.org/10.5281/zenodo.22547758\par}
\end{center}
\end{minipage}\hfill
\begin{minipage}[t]{3.1in}
\begin{center}
\includegraphics[width=2.15in]{qr_repo.png}\\[0.05in]
{\fontsize{15}{19}\selectfont\color{slate}\bfseries code + preregistrations\\
...
the best results.\\[0.22in]
\textbf{Scale:} roughly three billion simulated agents across eleven arms, all local
compute, zero API spend.}
\end{tcolorbox}
\end{textblock*}
...
\begin{center}\includegraphics[width=14.5in]{figure_acting.png}\end{center}
...
worth running. Above a cost ceiling, no dose helps.}\\[0.22in]
{\fontsize{27}{34}\selectfont\bfseries\color{accent}The numbers: SEBUS appears
between cost 0.2 and 0.3; at cost 1.2 the test never runs and no dose helps.}
\end{tcolorbox}
\end{textblock*}
...
\begin{center}\includegraphics[width=14.5in]{figure_gain.png}\end{center}
...
strengthening exists in one confirmed regime only: gain and cost together.}\\[0.22in]
{\fontsize{27}{34}\selectfont\bfseries\color{accent}The numbers: the confirmed
interior window spans doses 0.17 to 0.55 at strong gain with cost 0.1.}
\end{tcolorbox}
\end{textblock*}
...
\begin{center}\includegraphics[width=14.5in]{figure_window.png}\end{center}
...
replacing it: lasting conviction falls while insight never arrives.}\\[0.22in]
{\fontsize{27}{34}\selectfont\bfseries\color{accent}The numbers: lasting crossovers
sit at the acute ones, doses 0.25, 0.45, 0.55 at costs 0.3, 0.5, 0.8.}
\end{tcolorbox}
\end{textblock*}
...
\begin{center}\includegraphics[width=24.2in]{figure_ratchet.png}\end{center}
\pcap{Avoidance stores up the very doubt that eventually reopens the test; capture
never credits it, so conviction climbs to 0.99 and locks. \textbf{Avoidance loads the
trap, capture locks it.} Treatment fails three observable ways: subthreshold,
evidence-starved, or too late.}
\end{tcolorbox}
\end{textblock*}
...
\body{\begin{itemize}[leftmargin=0.6in, itemsep=0.2in]
